...
export default function AppDownloadPopup() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black/60 flex items-center justify-center p-4">
      <div className="relative bg-gradient-to-r from-[#3F9EB0] via-[#3E97AB] to-[#6cc3d5] rounded-2xl shadow-2xl max-w-3xl w-full overflow-hidden max-h-[90vh]">

        <button
          onClick={() => setOpen(false)}
          className="absolute top-4 right-4 bg-white/80 hover:bg-white rounded-full p-2 shadow cursor-pointer z-10"
        >
          <X size={18} />
        </button>
        ...
        <div className="grid md:grid-cols-2 gap-6 items-center p-6 md:p-8">
          <div>
            ...
            <p className="text-sm md:text-xl text-white font-medium mb-6 mt-4">
              Stop Overthinking, Start Investing.
            </p>
